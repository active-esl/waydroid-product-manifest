...
passed the image-integrity gate on the `fix/r16-image-integrity` branch. Verify
its retained checksums and provenance, publish and pin the immutable Android
pair, then build a successor to Foundries target 2943 with the Jaguar host
